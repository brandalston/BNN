...
model_runs.mip_run(["-o", 'margin-indicator', "-h", 0, "-c", 2, "-t", time_limit,
                    "-s", f's_{15}', "-e", 0.001, "-z", 0, "-f", 'bnn_runs.csv'])
...
for ec in examples_per_class:
    model_runs.mip_run(["-o", 'margin-indicator', "-h", 0, "-c", ec, "-t", time_limit,
